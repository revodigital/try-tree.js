...
export const metallicMaterialRed = new THREE.MeshStandardMaterial({
    color: 0x00FFFF, // You can adjust this color to whatever you like
    metalness: 1,  // High metalness for a metallic look
    roughness: 0.6  // Lower roughness for sharper reflections
});


export const metallicMaterialBlue = new THREE.MeshStandardMaterial({
    color: 0xFF00FF, // You can adjust this color to whatever you like
    metalness: 1,  // High metalness for a metallic look
    roughness: 0.6  // Lower roughness for sharper reflections
});
